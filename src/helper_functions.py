...
def train_models(pattern_ids, X_train, y_train, X_eval, y_eval, task_name, label_list,
    ...
    eval_data = prepare_data(X_eval, y_eval)
    ...
    for id in tqdm.tqdm(pattern_ids, desc='Training patterns', position=1, leave=True):
        ...
        pet.modeling.train_pet_ensemble(
            ...
            output_dir=output_dir, train_data=train_data, eval_data=eval_data, do_eval=True,
            save_unlabeled_logits=False, ipet_data_dir=None, repetitions = 10
        )
